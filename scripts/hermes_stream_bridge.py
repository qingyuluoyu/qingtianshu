...
This intentionally lives in a separate process using the Hermes virtual
environment. The web application never imports Hermes internals directly, and
the bridge keeps stdout reserved for a small machine-readable protocol.
"""
